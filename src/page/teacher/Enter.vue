...
import Heade from '../../components/heade.vue'
	export default {
      ...
      Heade
        ...
        dataList:[
          {name:'抗菌药与超级细菌',desc:"超级细菌肆虐、感染无药可医，人类正面临前所未有的困境。面对这危及每个人的严酷现实，我们该如何反击？",time:'2020-09-12',img:'http://nos.netease.com/edu-image/9F4E313F73803F25E2F82CBF24984FDA.png?imageView&thumbnail=426y240&quality=100'},
          ...
          {name:'计量地理学',desc:"计量地理学（Quantitative Geography）是一门方法论学科，它主要运用数学方法",time:'2020-12-30',img:'http://nos.netease.com/edu-image/7D8A1C0658BC6EF8FCBF80A4AD3DA338.jpg?imageView&thumbnail=426y240&quality=100'},
          {name:'外国经济思想史',desc:"学生通过本课程学习，在掌握西方经济思想的基本发展脉络",time:'2019-07-24',img:'http://nos.netease.com/edu-image/2BA7519DE80808BA2AA078F95BAFD43E.jpg?imageView&thumbnail=426y240&quality=100'},
